...
namespace Serverside.Login
{
    class Login
    {
        ...
        //{
        //    string trueMd5Hash;
        //    if (RPCore.FDb.GetPassword(Username, out trueMd5Hash))
        //    {
        //        string salt = RPCore.FDb.GetSalt(Username);
        ...
        //        }
        //        else if (RPCore.FDb.UserExist(Username) && trueMd5Hash.Equals(GenerateIpbHash(Password, salt)))
        //        {
        //            player.setSyncedData("AccountID", RPCore.FDb.GetAid(Username));
        //            player.setData("AccountID", RPCore.FDb.GetAid(Username));
