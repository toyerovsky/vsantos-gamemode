        ...
        private void API_onClientEventTrigger(Client sender, string eventName, params object[] arguments)
        {
            switch (eventName)
            {
                ...
                case "OnCreatorMotherChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.MotherId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorShapeMixChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.ShapeMix = float.Parse(arguments[0].ToString(), CultureInfo.InvariantCulture.NumberFormat);
                    }
                    break;
                case "OnCreatorSkinMixChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.SkinMix = float.Parse(arguments[0].ToString(), CultureInfo.InvariantCulture.NumberFormat);
                    }
                    break;
                case "OnCreatorHairChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.HairId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorHairTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.HairTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorHairColorChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.HairColor = Convert.ToInt32(arguments[0]);    
                    }
                    break;
                case "OnCreatorMakeupChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.MakeupId = Convert.ToInt32(arguments[0]);   
                    }
                    break;
                case "OnCreatorFirstMakeupColorChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator; 
                        if (characterCreator != null) characterCreator.FirstMakeupColor = Convert.ToInt32(arguments[0]);
                    }
                    break;
                ...
                case "OnCreatorLegsTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.LegsTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorTopChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.TopId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorTopTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.TopTexture = Convert.ToInt32(arguments[0]);
                ...
                case "OnCreatorHatChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.HatId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorHatTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.HatTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorGlassesChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.GlassesId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorGlassesTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.GlassesTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorEarsChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.EarsId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorEarsTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.EarsTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorAccessoryChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.AccessoryId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorAccessoryTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.AccessoryTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorTorsoChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.TorsoId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorUndershirtChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.UndershirtId = Convert.ToInt32(arguments[0]);
                    }
                    break;
                case "OnCreatorUndershirtTextureChanged":
                    {
                        var characterCreator = sender.GetAccountController().CharacterController.CharacterCreator;
                        if (characterCreator != null) characterCreator.UndershirtTexture = Convert.ToInt32(arguments[0]);
                    }
                    break;
            }
        }
